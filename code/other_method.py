...
def contrast_enhancement(image):
    ...
    #image_path = Path('DIP_term_project/code/images/low_chroma2.jpg')
    # image_path = Path('img7.jpg')
    # image_path = Path('img12.jpg')

    #image = plt.imread("DIP_term_project/code/images/low_chroma2.jpg")  # read image
    #image = image/255.0
    ...
    PSNR(image, clahe_rgb)
    PSNR(image, rgb_from_ycbcr)
    PSNR(image, rgb_image_idwt_hsv)

    SSIM(image, clahe_rgb)
    SSIM(image, rgb_from_ycbcr)
    SSIM(image, rgb_image_idwt_hsv)
    ...
    pyplot.title(f'Using CLAHE')
    pyplot.subplot(223)
    pyplot.imshow(rgb_from_ycbcr)
    pyplot.title('Using YCbCr colour map')
    pyplot.subplot(224)
    pyplot.imshow(rgb_image_idwt_hsv)
    pyplot.title('Using HSV colour map')
    pyplot.show()
